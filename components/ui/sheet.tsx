...
function SheetTrigger({
  ...
  return (
    <Button data-slot="sheet-trigger" asChild={asChild} onClick={() => context?.onOpenChange?.(true)} {...props}>
      {children}
    </Button>
  )
}
...
function SheetClose({
  ...
  return (
    <Button data-slot="sheet-close" asChild={asChild} onClick={() => context?.onOpenChange?.(false)} {...props}>
      {children}
    </Button>
  )
}
