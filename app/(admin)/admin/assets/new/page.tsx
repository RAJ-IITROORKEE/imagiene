  ...
  return (
    <main className="px-6 py-8 sm:px-10 lg:px-12">
      <div className="mx-auto grid max-w-5xl gap-8">
        <AdminPageHeader eyebrow="New asset" title="Create a protected image asset" description="Upload one image first. Metadata, private object keys, preview routing, and slug generation are handled automatically." />
